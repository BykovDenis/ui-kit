...
function getContrastText(color, dark, light) {
  return (0, _colorManipulator.getLuminance)(color) <= 0.5 ? dark : light;
}
...
function riskiCommonUITheme(primaryColor, lightPrimaryColor, lighterPrimaryColor, mostLighterPrimaryColor, darkPrimaryColor, secondaryColor, lightSecondaryColor, darkSecondaryColor, primaryFontColor, disabledBackgroundColor) {
  return {
    blockTitle: {
      marginTop: '20px',
      marginBottom: '20px',
    ...
    inputItem: {
      ...
      '& div:hover:before': {
        borderColor: "".concat(primaryColor, " !important")
      },
      '& p': {
        position: 'absolute',
        top: '50px'
...
var _default = riskiCommonUITheme;
