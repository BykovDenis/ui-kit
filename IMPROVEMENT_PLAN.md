...
### 2.1. [ ] Select: setState во время рендера + гонка debounce-фильтра
...
### 2.2. [ ] Анти-паттерн «props → useState»
...
### 3.2. [ ] Jenkinsfile: упростить и ускорить
...
### 3.3. [ ] Выровнять версии зависимостей
