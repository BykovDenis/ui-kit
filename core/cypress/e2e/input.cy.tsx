describe('The Input component', () => {
  ...
  it('Test1. Typing text. Testing name and value attributes', () => {
    ...
    cy.get('input[data-test=text]')
      .type('fdsfdsfd3er23dEds')
      .blur()
      .invoke('val')
      .should('equal', 'fdsfdsfd3er23dEds');
  });
  it('Test2. Typing numbers', () => {
    // mount(<Input type="number" name="input name" value="123" />)
    cy.get('input[data-test=digits-formatted]')
      .type('12345678')
      .blur()
      .invoke('val')
      .should('equal', '12 345 678');
  });
  ...
  it('Test6. Typing text', () => {
    // mount(<Input type="number" name="input name" value="123" />)
    cy.get('input[data-test=regular-expressions-symbols]')
      .type('ff12аааа34')
      .invoke('val')
      .should('equal', 'ffаааа');
  });
  it('Test7. Typing text regular expression complixity', () => {
    cy.get('input[data-test=regular-expressions-complixity]')
      .type('fdfd67')
      .invoke('val')
      .should('equal', 'fdfd67');
  });
  ...
  it('Test11. Typing text regular expression trim text', () => {
    cy.get('input[data-test=trim]')
      .type('    pg_ff6ewe       ')
      .invoke('val')
      .should('equal', 'pg_ff6ewe');
  });
});
