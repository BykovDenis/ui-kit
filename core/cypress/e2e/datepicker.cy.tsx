describe('The Datepicker component', () => {
  ...
  //   cy.get('#min-max-date-1').click().type('05102024').type('{enter}').should('value', '05.10.2024');
  //   // Typing value
  ...
  //   cy.get('#min-max-date-2').focus().type('20241012').blur().should('value', '2024-10-12');
  //   // Typing value
  ...
  //     '{leftArrow}{leftArrow}{leftArrow}{leftArrow}{leftArrow}{leftArrow}{leftArrow}{leftArrow}{leftArrow}{leftArrow}{del}{del}{del}{del}{del}{del}18.12.'
  //   );
  ...
  //     });
  // });
  // it('Test 43. Closing the Dialog when pressing past', () => {
  //   cy.get('#datepicker1').focus().click().type('01042024').blur();
  //   cy.get('#datepicker1').focus().click();
  //   cy.get('[data-cy="datepicker-datepicker1-container"]').click(145, 15);
  //   cy.get('[data-cy="datepicker-datepicker1-today-container"]').click(5, 15);
  //   cy.get('#get-previous-year-datepicker1').as('btn').click();
  //   cy.get('#get-next-year-datepicker1').as('btn').click();
  //   cy.get('#get-next-year-datepicker1').as('btn').click();
  //   cy.get('#get-previous-year-datepicker1').as('btn').click();
  //   cy.get('#get-previous-year-datepicker1').as('btn').click();
  //   cy.get('#get-previous-year-datepicker1').as('btn').click();
  //   cy.get('#get-previous-month-datepicker1').as('btn').click();
  //   cy.get('#get-previous-month-datepicker1').as('btn').click();
  //   cy.get('#get-next-month-datepicker1').as('btn').click();
  //   cy.get('#get-next-month-datepicker1').as('btn').click();
  //   cy.get('#get-next-month-datepicker1').as('btn').click();
  //   cy.get('[data-test="datepicker1"]')
  //     .find('[data-cy="datepicker-datepicker1-dates-dialog"]')
  //     .should('have.length', 1);
  //   cy.get('button[name="5"]').as('btn').click();
  //   cy.get('#datepicker1').should('value', '05.05.2022');
  // });
  // it('Test 44. Closing the Dialog when pressing past', () => {
  //   cy.get('#datepicker1').focus().click().type('01042024').blur();
  //   cy.get('#datepicker1').focus().click();
  //   cy.get('#get-previous-month-datepicker1').as('btn').click(2, 2);
