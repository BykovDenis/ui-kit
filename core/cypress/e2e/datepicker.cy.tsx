...
describe('The Datepicker component', () => {
  ...
  it('Test 6. Selection by click text after invalid typing value  (onChange)', () => {
    ...
    cy.get('button[data-test="btn-delete-value"]')
      .as('btn')
      .parent()
      .click();
    cy.get('#datepicker1')
  ...
  it('Test 11. Change to previous month  (onBlur)', () => {
    ...
    cy.get('#datepicker2')
      ...
      .click()
      .then(() => {
        cy.get('#get-previous-month-datepicker2')
          .as('btn')
          .click();
        cy.get('#get-previous-month-datepicker2')
          .as('btn')
          .click();
        cy.get('button[name="5"]')
          .as('btn')
          .click();
        cy.get('#datepicker2')
  ...
  it('Test 12. Change to next month  (onBlur)', () => {
    ...
    cy.get('#datepicker2')
      ...
      .click()
      .then(() => {
        cy.get('#get-next-month-datepicker2')
          .as('btn')
          .click();
        cy.get('#get-next-month-datepicker2')
          .as('btn')
          .click();
        cy.get('button[name="20"]')
          .as('btn')
          .click();
  ...
  it('Test 13. Change to previous year (onBlur)', () => {
    ...
    cy.get('#datepicker2')
      ...
      .click()
      .then(() => {
        cy.get('#get-previous-year-datepicker2')
          .as('btn')
          .click();
        cy.get('#get-previous-year-datepicker2')
          .as('btn')
  ...
  it('Test 14. Change to next year  (onBlur)', () => {
    ...
    cy.get('#datepicker2')
      ...
      .click()
      .then(() => {
        cy.get('#get-next-year-datepicker2')
          .as('btn')
          .click();
        cy.get('#get-next-year-datepicker2')
          .as('btn')
  ...
  it('Test 29. Change month and year from dropdown (onChange)', () => {
    ...
    cy.get('#datepicker1')
      .focus()
      .click();
    cy.get('#datepicker-month-datepicker1')
      .click()
      .focus();
    cy.get('#datepicker-month-datepicker1-list > div:nth-of-type(9) > button')
      .as('btn')
      .click();
    cy.get('#datepicker1').should('value', '03.09.2024');
    cy.get('#datepicker-year-datepicker1')
      .click()
      .focus();
    cy.get('button[data-value="2025"]')
      .as('btn')
      .click();
  ...
  it('Test 30. Change month and year from dropdown (onBlur)', () => {
    cy.get('#datepicker2')
      ...
      .type('2024-05-19')
      .blur()
      .should('value', '2024-05-19');
    cy.get('#datepicker2')
      .focus()
      .click();
    cy.get('#datepicker-month-datepicker2')
      .click()
      .focus();
    cy.get('#datepicker-month-datepicker2-list > div:nth-of-type(9) > button')
      .as('btn')
      .click();
    cy.get('#datepicker2').should('value', '2024-09-19');
    cy.get('#datepicker-year-datepicker2')
      .click()
      .focus();
    cy.get('button[data-value="2028"]')
      .as('btn')
      .click();
