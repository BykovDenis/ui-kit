...
const StickyBottomPanelStyled = styled.div<TStickyBottomPanel>`
  ...
  z-index: ${(props: TStickyBottomPanel) => props.zIndex ?? 10002};
  padding-top: 45px;
  ...
  background: ${(props: TStickyBottomPanel) =>
    props.backgroundColor || props.backgroundImage
      ? `${props?.backgroundColor ? props.backgroundColor : ''} ${props?.backgroundImage ? props.backgroundImage : ''}`
      : 'none'};
