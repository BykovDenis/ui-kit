...
const DatepickerTesting = () => {
  ...
  const [date2, setDate2] = useState('2023-08-25');
  ...
  return (
    <FlexContainer justifyContent="flex-start">
      ...
      <FlexContainer width={250}  margin="20px 10px"><Datepicker value={date1} onChange={onDate1Change} mask="dd.MM.yyyy" variant="outlined" label="Datepicker2 RU" id="datepicker2" name="datepicker2" locale="RU" height={60} /></FlexContainer>
